...
class Test(AbstractBaseModel):
    ...
    questions = relationship("Question", backref=backref("test", lazy="selectin"), lazy="selectin")
    sessions = relationship("Session", backref=backref("test", lazy="selectin"), lazy="selectin")
...
class Question(AbstractBaseModel):
    ...
    text = Column(Text)
    answers = relationship("Answer", backref=backref("question", lazy="selectin"), lazy="selectin")
...
class Answer(AbstractBaseModel):
    ...
    user_answers = relationship("UserAnswer", backref=backref("answer", lazy="selectin"), lazy="selectin")
