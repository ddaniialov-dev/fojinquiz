...
@user_router.post(
    "/register/", response_class=JSONResponse, status_code=status.HTTP_201_CREATED
)
async def register(
...
@user_router.post(
    "/refresh/", response_class=JSONResponse, status_code=status.HTTP_201_CREATED
)
...
@user_router.get("/me/", response_model=UserGet, status_code=status.HTTP_200_OK)
